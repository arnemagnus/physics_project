...
approximations $x_{1}$ and $\widehat{x}_{1}$, yielding the difference
$x_{1}-\widehat{x}_{1}$ as an estimate of the error of the less precise result.
The idea is to enforce the error of the numerical solution to satisfy
componentwise:
