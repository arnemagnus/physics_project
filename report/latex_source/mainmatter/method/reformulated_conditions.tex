...
chosen to be an order of magnitude smaller than the main grid spacing, in
order to ensure that the micro-scale strain behaviour would be accurately
represented in the resulting strainlines, while maintaining reasonable
computation times.
%presented in
