...
Then, orientational discontinuities inbetween the grid elements are identified
...
The entire process of the special-purpose local linear interpolation method is
...
\cref{cha:discussion}. The curve shown in figure~\ref{referencelcs} was used to
