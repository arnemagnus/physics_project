...
\begin{defn}
    ...
    A Runge-Kutta method, given by equation~\eqref{eq:generalrungekutta} is
...
\begin{gather}
    ...
    \end{aligned}
\end{gather}
where $\widetilde{K}$ is a numerical constant. Equation
\eqref{eq:rungekuttaglobalorderestimate} demonstrates that, for a $p$-th
...
methods is outlined in equation~\eqref{eq:exim}.
