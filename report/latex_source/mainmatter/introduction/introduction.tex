...
described by means of discrete samples obtained from some sort of model for the
...
addition to a little bit of experience within programming, should be able to
