...
\subsection{The singlestep methods}
\label{sub:the_singlestep_methods}
...
order accurate. On a less surprising note, seeing as it is \nth{4} order
accurate, the classical Runge-Kutta scheme produces very accurate curves for
all step lengths.

\subsection{The adaptive stepsize methods}
\label{sub:the_adaptive_stepsize_methods}
