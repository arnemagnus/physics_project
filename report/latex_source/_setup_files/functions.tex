...
\renewcommand{\cfttoctitlefont}{\hspace*{\fill}\fontsize{16pt}{16pt}\bfseries}
...
% (Finish) centering the LoF title
\renewcommand{\cftafterloftitle}{\hfill\mbox{}}
% Spacing after the LoF title, adjusted so that the following text is lined
% up with the text content after a new chapter heading positioned at the top
% of a new page
...
% (Finish) centering the LoT title
\renewcommand{\cftafterlottitle}{\hfill\mbox{}}
% Spacing after the LoT title, adjusted so that the following text is lined
% up with the text content after a new chapter heading positioned at the top
% of a new page
